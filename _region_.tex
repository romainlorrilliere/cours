\message{ !name(cours_DIE_ONIRIS_Suivi_populations_oiseaux.tex)}\documentclass[10pt]{beamer}
...
\institute{ENVT : DIE Santé de la faune sauvage non captive (mars 2023)}
\date{14 mars 2022}
...
\message{ !name(cours_DIE_ONIRIS_Suivi_populations_oiseaux.tex) !offset(-3) }
...
\begin{frame}{Où poussent les plumes l'hiver}
  \begin{center}
    ...
    \includegra phics<4>[width=0.6\textwidth]{ortolan_koweit_4}
  \end{center}
...
\message{ !name(cours_DIE_ONIRIS_Suivi_populations_oiseaux.tex) !offset(-1390) }
