...
\begin{frame}{Diversification : 10000 sp}
  \begin{center}
   \includegraphics<1>[width=0.7\textwidth]{BirdTreeLarge} 
    \includegraphics<2>[width=0.9\textwidth]{divOiseaux2_2} 
  \end{center}
\end{frame}
...
\begin{frame}{Indicateur de biodiversité}
  \begin{center}
    \includegraphics[width=.9\textwidth]{indicateurs} 
  \end{center}
\end{frame}
...
\begin{frame}{Modification de la phénologie de la migration}
  \begin{center}
    ...
    \vspace{20pt}
    \includegraphics[width=.9\textwidth]{spMigratrices}
  \end{center}
\end{frame}
...
\begin{frame}{Changements des zones d’hivernage}
  ...
  \vspace{10pt}
  \includegraphics[width=.8\textwidth]{changementZoneHiver}
  \end{center}
\end{frame}

\begin{frame}{Distribution hivernal: Gobemouche à collier}
  \begin{center}
   \includegraphics[width=.9\textwidth]{GobeMoucheCollier}
  \end{center}
\end{frame}
...
\begin{frame}{Le milieu marin et la sur-pêche}
 \begin{columns}[c]
    \begin{column}[c]{0.5\textwidth}
      \begin{center}
     \includegraphics[width=.6\textwidth]{fouvarie}\\
    ...
    \includegraphics[width=\textwidth]{fisheriesAndSeabird}
    \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{Protocole STOC: indicateurs}
\begin{center}
  \includegraphics[width=.7\textwidth]{ctri}
...
\begin{frame}{Suivre ou ne pas suivre sa niche climatique…}
 \begin{center}
   \includegraphics[width=.8\textwidth]{CTI}
 \end{center}
